...
impl RegisterSnapshot {
    ...
    pub fn get_value(&self, register: &Register) -> RegisterValue {
        ...
        match register {
            ...
            // 8-bit high
            Register::AH => RegisterValue::Uint64(((self.user_gp.rax >> 8) & 0xff) as u64),
            Register::DH => RegisterValue::Uint64(((self.user_gp.rdx >> 8) & 0xff) as u64),
            Register::CH => RegisterValue::Uint64(((self.user_gp.rcx >> 8) & 0xff) as u64),
            Register::BH => RegisterValue::Uint64(((self.user_gp.rbx >> 8) & 0xff) as u64),

            // 8-bit low
            Register::AL => RegisterValue::Uint64((self.user_gp.rax & 0xff) as u64),
            Register::DL => RegisterValue::Uint64((self.user_gp.rdx & 0xff) as u64),
            Register::CL => RegisterValue::Uint64((self.user_gp.rcx & 0xff) as u64),
            Register::BL => RegisterValue::Uint64((self.user_gp.rbx & 0xff) as u64),
            Register::SIL => RegisterValue::Uint64((self.user_gp.rsi & 0xff) as u64),
            Register::DIL => RegisterValue::Uint64((self.user_gp.rdi & 0xff) as u64),
            Register::BPL => RegisterValue::Uint64((self.user_gp.rbp & 0xff) as u64),
            Register::SPL => RegisterValue::Uint64((self.user_gp.rsp & 0xff) as u64),
            Register::R8B => RegisterValue::Uint64((self.user_gp.r8 & 0xff) as u64),
            Register::R9B => RegisterValue::Uint64((self.user_gp.r9 & 0xff) as u64),
            Register::R10B => RegisterValue::Uint64((self.user_gp.r10 & 0xff) as u64),
            Register::R11B => RegisterValue::Uint64((self.user_gp.r11 & 0xff) as u64),
            Register::R12B => RegisterValue::Uint64((self.user_gp.r12 & 0xff) as u64),
            Register::R13B => RegisterValue::Uint64((self.user_gp.r13 & 0xff) as u64),
            Register::R14B => RegisterValue::Uint64((self.user_gp.r14 & 0xff) as u64),
            Register::R15B => RegisterValue::Uint64((self.user_gp.r15 & 0xff) as u64),
